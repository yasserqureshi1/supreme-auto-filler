chrome.runtime.onMessage.addListener(
    function(request, sender, sendResponse) {
        try {
            ...
            document.getElementById("bo").value = request.address1;
            document.getElementById("oba3").value = request.address2;
